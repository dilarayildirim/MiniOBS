...
namespace MiniOBS
{
    public partial class Form1 : Form
    {
        ...
        private void denemeRaporToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DenemeRapor denemeRaporFormu = new DenemeRapor();
            denemeRaporFormu.MdiParent = this;
            denemeRaporFormu.Show();
        }

        private void denemeRapor2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DenemeRapor2 denemeRaporFormu2 = new DenemeRapor2();
            denemeRaporFormu2.MdiParent = this;
            denemeRaporFormu2.Show();
        }
